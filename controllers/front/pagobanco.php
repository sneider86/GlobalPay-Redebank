...
class RedebanglobalpayPagobancoModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        $this->setTemplate('module:redebanglobalpay/views/templates/front/pagobanco.tpl');
    }
}